        ...
        <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form role="form" action="/13_class/two_object/project/index.php/Admin/Role/doaddnode" method="post">
                            <div class="form-group">
                                <label for="exampleInputPassword1">节点名</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="NodeName" name="name">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">控制器名</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="MName" name="mname">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">方法名</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="AName" name="aname">
                            </div>
