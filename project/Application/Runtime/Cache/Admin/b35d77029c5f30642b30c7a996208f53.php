   ...
   <div class="main-content"> 
    ...
    <!-- page heading end-->  
        ...
        <?php if(is_array($list)): foreach($list as $key=>$row): ?><tr class="gradeX">
            ...
            <a href="/13_class/two_object/project/index.php/Admin/Role/nodelist?id=<?php echo ($row['id']); ?>"><div class="fa fa-cogs"></div> </a>&nbsp;&nbsp;
            <a href="/13_class/two_object/project/index.php/Admin/Role/edit?id=<?php echo ($row['id']); ?>"><div class="fa fa-edit"></div> </a>&nbsp;&nbsp;
            <a href="/13_class/two_object/project/index.php/Admin/Role/del?id=<?php echo ($row['id']); ?>"><div class="fa fa-trash-o"></div></a></td>
