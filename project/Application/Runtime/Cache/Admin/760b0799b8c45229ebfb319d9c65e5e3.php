   ...
   <div class="main-content"> 
    ...
    <!-- page heading end-->  
        ...
        <tr>
            ...
            <th style="text-align:center">控制器名</th>
        ...
        <?php if(is_array($list)): foreach($list as $key=>$row): ?><tr class="gradeX">
            ...
            <a href="/13_class/two_object/project/index.php/Admin/Role/editnode?id=<?php echo ($row['id']); ?>"><div class="fa fa-edit"></div> </a>&nbsp;&nbsp;
            <a href="/13_class/two_object/project/index.php/Admin/Role/delnode?id=<?php echo ($row['id']); ?>"><div class="fa fa-trash-o"></div></a></td>
