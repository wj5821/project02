        ...
        <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form role="form" action="/13_class/two_object/project/index.php/Admin/User/doinfoadd" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="sex" name="sex">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">居住地址</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="exampleInputPassword1" placeholder="pic" name="pic">
                            </div>
