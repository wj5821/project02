 ...
 <body class="sticky-header"> 
  <section> 
   ...
   <div class="main-content"> 
    ...
    <script type="text/javascript" src="/13_class/two_object/project/Public/Admin/js/jquery-1.8.3.min.js"></script>
	   <div class="row">
        <div class="col-sm-12">
        <section class="panel">
        ...
        <tr>
            ...
            <th style="text-align:center">居住地址</th>
        </tr>
        </thead>
        <tbody>
        <?php if($list != null): ?><tr class="gradeX">
            ...
            <td><img src="/13_class/two_object/project/Public/Uploads/<?php echo ($list['pic']); ?>" width="40px"></td>
            <td><?php echo ($list['address']); ?></td>
        </tr>
        <?php else: ?><td colspan="9">暂无数据</td><?php endif; ?>
        </tfoot>
        </table>
        </div>
        </div>
