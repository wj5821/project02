  ...
  <section> 
   ...
   <div class="main-content"> 
    ...
    <!-- page heading end-->  
        ...
        <div class="adv-table">
        <table  class="display table table-bordered table-striped" id="dynamic-table" style="text-align:center">
        <thead>
        <tr>
            ...
            <th style="text-align:center" class="hidden-phone">添加时间</th>
            <th style="text-align:center" class="hidden-phone" width="10%">操作</th>
        </tr>
        </thead>
        <tbody>
        <?php if(is_array($list)): foreach($list as $key=>$row): ?><tr class="gradeX">
            <td><?php echo ($row['id']); ?></td>
            <td><?php echo ($row['uname']); ?></td>
            <td><?php echo ($row['pwd']); ?></td>
            <td><?php if($row['level'] == 0): ?>普通用户<?php elseif($row['level'] == 1): ?>Vip<?php else: ?>管理员<?php endif; ?></td>
            <td class="center hidden-phone"><?php echo (date("Y-m-d H:i:s",$row['addtime'])); ?></td>
            <td class="center hidden-phone">
            <a href="/13_class/two_object/project/index.php/Admin/User/rolelist?id=<?php echo ($row['id']); ?>"><div class="fa fa-cogs"></div> </a>&nbsp;&nbsp;
            <a href="/13_class/two_object/project/index.php/Admin/User/edit?id=<?php echo ($row['id']); ?>"><div class="fa fa-edit"></div> </a>&nbsp;&nbsp;
            <a href="/13_class/two_object/project/index.php/Admin/User/del?id=<?php echo ($row['id']); ?>"><div class="fa fa-trash-o"></div></a></td>
