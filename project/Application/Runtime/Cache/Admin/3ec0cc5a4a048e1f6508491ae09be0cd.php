   ...
   <div class="main-content"> 
    ...
    <!-- page heading end-->  
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <form action="/13_class/two_object/project/index.php/Admin/User/dorole?id=<?php echo ($user['id']); ?>" method="post">
                            <div class="panel-body"><h4>为用户 <u style="font-size: 15px"><?php echo ($user['uname']); ?> </u>分配角色:</h4></div>
                            <div class="col-lg-1"></div>
                            <div class="panel-body col-lg-10" style="height: 200px">
                                <?php if(is_array($rolelist)): $i = 0; $__LIST__ = $rolelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$role): $mod = ($i % 2 );++$i; echo ($role['name']); ?>:<input type="checkbox" <?php if(in_array($role['id'],$r)): ?>checked<?php endif; ?> value="<?php echo ($role['id']); ?>" name="rids[]">&nbsp;&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
