        ...
        <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form role="form" action="/13_class/two_object/project/index.php/Admin/Role/updatenode" method="post">
                            <div class="form-group">
                                <label for="exampleInputPassword1">节点名</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="RoleName" name="name" value="<?php echo ($list['name']); ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">控制器名</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="MName" name="mname" value="<?php echo ($list['mname']); ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">方法名</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="AName" name="aname" value="<?php echo ($list['aname']); ?>">
                            </div>
